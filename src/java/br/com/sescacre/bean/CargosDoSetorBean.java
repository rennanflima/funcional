...
import br.com.sescacre.dao.CargosDoSetorDAO;
import br.com.sescacre.dao.FuncionarioDAO;
import br.com.sescacre.entidades.Cargos;
import br.com.sescacre.entidades.CargosDoSetor;
import br.com.sescacre.entidades.Funcionarios;
import br.com.sescacre.entidades.Setores;
...
public class CargosDoSetorBean implements Serializable {
    ...
    public String excluir(CargosDoSetor cds) throws Exception {
        ...
        FacesContext msg = FacesContext.getCurrentInstance();
        try {
            func = new FuncionarioDAO().pesquisaFuncionarioPorCargoDoSetor(cds.getIdCargoDoSetor());
            if (func.isEmpty()) {
                cdsd.excluir(cds);
                cDoSetor = new CargosDoSetor();
            } else {
